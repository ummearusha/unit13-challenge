...
def validate_data(age, investment_amount, first_name):

        if age is None:
            return build_validation_result(
                False,
                "age",
                "Please enter your age between 0 and 65."
            )
        ...
        if investment_amount is None:
            return build_validation_result (
                False,
                "investmentAmount",
                "Please enter investment amount equal or greater than 5000.",
            ) 
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
       ...
       # Validate that the user age is between 0 and  65 years old
        validation_result = validate_data(age, investment_amount, first_name)
